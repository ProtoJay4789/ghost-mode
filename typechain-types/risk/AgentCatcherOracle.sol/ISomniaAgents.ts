...
export interface ISomniaAgentsInterface extends Interface {
  getFunction(
...
export interface ISomniaAgents extends BaseContract {
  connect(runner?: ContractRunner | null): ISomniaAgents;
  waitForDeployment(): Promise<this>;

  interface: ISomniaAgentsInterface;
